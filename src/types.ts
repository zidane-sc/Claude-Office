...
export const AGENT_CONFIGS: Record<string, { color: string; emoji: string; title: string }> = {
  ...
  'performance-engineer':  { color: '#f1c40f', emoji: '💰', title: 'Hermes @Finance' },
  'devops-engineer':       { color: '#607d8b', emoji: '🚜', title: 'Hermes @Farm' },
  'database-architect':    { color: '#795548', emoji: '💊', title: 'Hermes @Roxy' },
  'typescript-pro':        { color: '#3178c6', emoji: '🎓', title: 'Hermes @Study' },
  ...
  'Explore':               { color: '#e91e63', emoji: '❤️', title: 'Hermes @Couples' },
  // MCPs
